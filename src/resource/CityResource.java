...
import cm4108.lab05.config.*;
import exception.*;
import cm4108.lab05.city.model.*;
...
public class CityResource {
	 ...
	 * @return
	 */
	public Response addCity(String code, String name, double longitude, double latitude) {
		try {
			//
			// You should:
			//
			...
			return Response.status(201).entity(code + "/" + name + " (" + longitude + "," + latitude + ") saved sucessfully").build(); // a
																													// successful
																													// reply
		}
		catch (Exception e) {
	...
	/**
	 * This method should handle a GET request to the URL pattern
	 * "/lab05/api/city/<code>" to retrieve a city's information and return it as a
	 * JSON map.
	 * 
	 * @param code
	 * @return The Cit.y object retrieved using the given code. This City object
	 *         should be converted to JSON by Jackson
	 */
	public City retrieveOneCity(String code) {
		...
		// *** Note: If city ID/code cannot be found, you should return an appropriate
		// error.
		//
	...
	/**
	 * This method handles a GET request to the URL "/lab05/api/city" to retrieve
	 * all cities as a JSON list.
	 * 
	 * @return
	 */
